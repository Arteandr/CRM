...
function tamingselect() {
   ...
   */
   ...
   const tab_items = document.querySelectorAll(".tabs__items");
   const copy_btns = document.querySelectorAll(".copy__item");
   const select = document.querySelector(".__select");
   select.addEventListener("click", () => closeAllDropdown(false))
   copy_btns.forEach(btn => btn.addEventListener("click", closeAllDropdown))
   tab_items.forEach(tab => tab.addEventListener("click", closeAllDropdown))
   function closeAllDropdown(closeWithSelect = true) {
      const elements = document.querySelectorAll(".activetrigger");
      if(!elements) return;
